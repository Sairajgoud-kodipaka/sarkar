...
const mockArticle = {
  ...
  content: 'Step 1: Go to Products. Step 2: Click Add New. ...',
};

export default function EditArticlePage() {
  const [form, setForm] = useState({ title: mockArticle.title, content: mockArticle.content });
  ...
  return (
    <div className="max-w-xl mx-auto">
      <h1 className="text-2xl font-semibold mb-6 text-text-primary">Edit Article</h1>
      <Card className="p-8">
