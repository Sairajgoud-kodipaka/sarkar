      ...
      if (response.success && response.data) {
        ...
        const transformedAppointments: Appointment[] = response.data.map((apt: any) => {
          ...
          return {
            ...
            appointment_date: appointmentDateTime.toISOString().split('T')[0], // YYYY-MM-DD format
            appointment_time: appointmentDateTime.toTimeString().slice(0, 5), // HH:MM format
            duration: apt.duration_minutes || 60,
            type: 'consultation' as const, // Default type since database doesn't have this field
            ...
            notes: apt.notes || '',
            total_value: undefined // Database doesn't have this field
          };
        });
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <Badge className={getTypeColor(appointment.type || 'consultation')}>
                      {(appointment.type || 'consultation').replace('_', ' ').toUpperCase()}
                    </Badge>
